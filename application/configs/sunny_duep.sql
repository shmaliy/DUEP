...
--
-- Host: localhost
-- Generation Time: Aug 03, 2012 at 01:15 AM
...
CREATE TABLE IF NOT EXISTS `contents` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='таблица контента, являет собой сборную солянку всех требуемы' AUTO_INCREMENT=66 ;
