...
(7, 'Мультигалереи', 'multi_gallerys', 'Группа мультигалерей', 7, 1, 'Создано в phpMyAdmin', 1, 1341394795, 1341394814);
