...
{	
	...
	public function indexAction()
    {
    	...
    	$this->view->actual = $contentsMapper->getFrontContentsByGroupId(array ($this->view->ngroup->id, $this->view->agroup->id), $langs[1],'date_created desc',5);
    ...
    */
    public function viewAction()
    {
    	...
    	$this->view->event = $contentMapper->getFrontContentByAlias($alias, $langs[1]);
