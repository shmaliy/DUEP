	...
	<div class="admin-actions">
		<ul>
			<li class="single"><a class="add" href="<?php
				echo $this->simpleUrl('static-edit', $this->c, $this->m, array('group' => $this->group->alias));
			?>"></a></li>
			...
			<?php if (count($this->rowset) > 0): ?>
				<?php foreach ($this->rowset as $row): ?>
					<tr>
						...
						<td><div><a href="<?php
							echo $this->simpleUrl('static-edit', $this->c, $this->m, array('id' => $row->getId(), 'group' => $this->group->alias));
