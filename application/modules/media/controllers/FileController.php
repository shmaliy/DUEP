...
class Contents_FileController extends Zend_Controller_Action
{	
	/**
	...
	/**
	 * Обработчик страницы "Список всех документов Файлового Архива"
	 */
    ...
    /**
    * Обработчик страницы "Отдельног документа Файлового Архива"
    */
