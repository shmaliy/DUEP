...
class Users_AdminGroupsController extends Sunny_Controller_AdminAction
{
	...
	public function indexAction()
    {
		...
		$form = new Users_Form_AdminGroupsFilter();
		$collection = $this->_getMapper()->fetchTree(null, array('id', 'title', 'users_groups_id'));
    ...
    public function setFilterAction()
    {
		...
		$form->getElement('users_groups_id')
